...
import Svg, { G, Path, SvgProps, SvgXml } from "react-native-svg";
...
export const RemixIcons = (
  ...
  //   return <SvgXml xml={svg} width="100%" height="100%" {...props} />;
  return (
    <Icon {...props} viewBox="0 0 24 24">
      <SvgXml xml={icons[props.name]} width="100%" height="100%" />
